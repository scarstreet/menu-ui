<template>
  ...
  <div v-if="canCraft">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  class="fill-[#ddae62] bg-amber-50 p-[4px] rounded-lg w-[32px]"><title>keyboard-space</title><path d="M3 15H5V19H19V15H21V19C21 20.1 20.1 21 19 21H5C3.9 21 3 20.1 3 19V15Z" /></svg>
  </div>
  ...
  <div v-if="canCraft" class="text-amber-50">Craft More</div>
